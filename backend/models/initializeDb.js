...
class initializeDb{
    static dbInitialization = async ()=>{
        ...
        sql = `CREATE TABLE products (id SERIAL PRIMARY KEY, title VARCHAR, description TEXT, image VARCHAR, price VARCHAR, quantity INT, buying_price VARCHAR, category VARCHAR, regtime timestamp);`;
        await dbConnect.queryDb(sql);
